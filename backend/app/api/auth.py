...
# 5 запросов в 60 секунд на эндпоинты регистрации/логина
_auth_limiter = Limiter(Rate(5, Duration.SECOND * 60))
...
@router.post(
    ...
    dependencies=[Depends(RateLimiter(limiter=_auth_limiter))],
)
async def register(
    data: UserCreate,
